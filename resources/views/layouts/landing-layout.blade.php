...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Text Gradient */
        .text-gradient {
            background-image: linear-gradient(to right, #93C5FD, #A5B4FC, #C084FC);
            /* from-blue-300 via-indigo-300 to-purple-400 - Extra bright & saturated! */
...
<body class="@yield('body-class')">
    ...
    @if(!View::hasSection('body-class') || View::getSection('body-class') !== 'login-page')
        <a href="https://wa.me/6282379601227?text=Halo%20Coding%20Academy%20Payakumbuh%2C%20saya%20ingin%20bertanya%20tentang%20program%20kursus"
            target="_blank" rel="noopener noreferrer" class="floating-whatsapp" aria-label="Hubungi via WhatsApp">
