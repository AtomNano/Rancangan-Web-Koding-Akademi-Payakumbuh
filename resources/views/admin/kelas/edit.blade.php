                    ...
                    <form action="{{ route('admin.kelas.update', $kelas->id) }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <select name="bidang" id="bidang" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                <option value="coding" {{ old('bidang', $kelas->bidang) == 'coding' ? 'selected' : '' }}>Coding</option>
                                <option value="desain" {{ old('bidang', $kelas->bidang) == 'desain' ? 'selected' : '' }}>Desain</option>
                                <option value="robotik" {{ old('bidang', $kelas->bidang) == 'robotik' ? 'selected' : '' }}>Robotik</option>
                                <option value="umum" {{ old('bidang', $kelas->bidang) == 'umum' ? 'selected' : '' }}>Umum</option>
                                <option value="mahasiswa" {{ old('bidang', $kelas->bidang) == 'mahasiswa' ? 'selected' : '' }}>Mahasiswa</option>
                            </select>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="deskripsi" name="deskripsi" rows="4" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>{{ old('deskripsi', $kelas->deskripsi) }}</textarea>
