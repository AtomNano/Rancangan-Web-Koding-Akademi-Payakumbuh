<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center">
            <a href="{{ route('admin.pertemuan.index', $kelas->id) }}" class="text-indigo-500 hover:text-indigo-700">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                </svg>
            </a>
            <h2 class="ml-3 font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Tambah Pertemuan: ') . $kelas->nama_kelas }}
            </h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.pertemuan.store', $kelas->id) }}" method="POST">
                        @csrf
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="judul_pertemuan" 
                                              ...
                                              :value="old('judul_pertemuan')" 
                                              required 
                                              autofocus 
                                              placeholder="Contoh: Pertemuan 1 - Pengenalan HTML" />
                                <p class="mt-1 text-xs text-gray-500">Judul yang jelas untuk pertemuan ini</p>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea id="deskripsi" 
                                          ...
                                          rows="3" 
                                          class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                          placeholder="Deskripsi singkat tentang materi yang akan dibahas...">{{ old('deskripsi') }}</textarea>
                            </div>
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <a href="{{ route('admin.pertemuan.index', $kelas->id) }}" 
