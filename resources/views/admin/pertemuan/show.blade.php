                        ...
                        <div class="max-h-96 overflow-y-auto divide-y divide-gray-200">
                            ...
                            @if($allPertemuans->count() > 0)
                                @foreach($allPertemuans as $p)
                                    <a href="{{ route('admin.pertemuan.show', ['kelas' => $kelas->id, 'pertemuan' => $p->id]) }}" 
            ...
            @if($siswa->count() > 0)
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <form action="{{ route('admin.pertemuan.absen', ['kelas' => $kelas->id, 'pertemuan' => $pertemuan->id]) }}" method="POST" id="absenForm">
                            @csrf
