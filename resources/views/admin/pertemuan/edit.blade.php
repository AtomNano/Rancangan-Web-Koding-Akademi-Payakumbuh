<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center">
            <a href="{{ route('admin.pertemuan.show', ['kelas' => $kelas->id, 'pertemuan' => $pertemuan->id]) }}" class="text-indigo-500 hover:text-indigo-700">
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.pertemuan.update', ['kelas' => $kelas->id, 'pertemuan' => $pertemuan->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500">Ubah pengajar yang bertanggung jawab atas pertemuan ini</p>
                            </div>
