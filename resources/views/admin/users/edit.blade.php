                        ...
                        <div class="p-6 bg-gray-50 border-b border-gray-200">
                            ...
                            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    @php
                                        $currentEnrollmentStatus = $user->enrollments->first()->status ?? 'inactive';
                                    @endphp
                                    <select id="enrollment_status" name="enrollment_status" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                        <option value="active" {{ old('enrollment_status', $currentEnrollmentStatus) == 'active' ? 'selected' : '' }}>Aktif</option>
                                        <option value="inactive" {{ old('enrollment_status', $currentEnrollmentStatus) == 'inactive' ? 'selected' : '' }}>Tidak Aktif</option>
                                    </select>
                                </div>
                            </div>
                        </div>
