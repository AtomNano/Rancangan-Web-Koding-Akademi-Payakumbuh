<!-- Pricing Section -->
<section id="pricing" class="relative overflow-hidden py-24">
    ...
    <div class="container relative z-10 mx-auto px-6">
        ...
        <div class="mt-16 flex flex-col items-start gap-6 rounded-3xl border border-white/15 bg-white/5 p-8 shadow-2xl shadow-blue-900/30 backdrop-blur-xl md:flex-row md:items-center md:justify-between">
            <div>
