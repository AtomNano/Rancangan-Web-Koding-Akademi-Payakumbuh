<!-- Footer -->
<footer id="kontak" class="relative border-t border-white/10 bg-white/5 text-white backdrop-blur-xl">
            ...
            <div>
                ...
                <ul class="mt-6 space-y-4 text-sm text-white/75">
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        Butuh panduan penggunaan platform? <a href="#kelas" class="ml-1 underline decoration-dotted underline-offset-4 hover:text-white">Lihat tutorial singkat</a>
                    </li>
                </ul>
