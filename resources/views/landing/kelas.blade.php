        ...
        <div class="mt-16 grid gap-8 lg:grid-cols-3">
            ...
            <div class="group relative flex h-full flex-col overflow-hidden rounded-3xl border border-white/15 bg-white/5 p-8 shadow-2xl shadow-blue-900/30 backdrop-blur-xl transition-transform duration-300 hover:-translate-y-2">
                ...
                <div class="relative flex items-center justify-between">
                    <span class="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/15 px-4 py-1 text-xs font-semibold uppercase tracking-[0.25em] text-white/80">
                        Coding
                ...
                <div class="relative mt-6 flex items-start gap-4">
                    <div class="flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-500/20 text-white">
                        <svg class="h-7 w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9 19V6l12-4v13M9 19l12-4M9 19l-6-2m6-11L3 6v11l6 2m6-15v5"></path>
                        </svg>
                    </div>
                    <div>
                        ...
                        <p class="mt-3 text-sm leading-relaxed text-white/75">
                            Pahami algoritma dasar hingga membangun aplikasi pertama dengan Python. Cocok untuk pemula ambisius yang ingin menjejak karier teknologi.
                        </p>
                    </div>
                </div>
                <dl class="mt-8 space-y-4 text-sm text-white/80">
                ...
                <div class="mt-9">
                    <a href="#pricing" class="inline-flex w-full items-center justify-center rounded-2xl bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-600 px-6 py-3 text-sm font-bold text-white shadow-lg shadow-blue-500/30 transition-transform duration-300 hover:scale-[1.02]">
                        Lihat Paket & Jadwal
                    </a>
                </div>
            </div>
            ...
            <div class="group relative flex h-full flex-col overflow-hidden rounded-3xl border border-white/15 bg-white/5 p-8 shadow-2xl shadow-purple-900/30 backdrop-blur-xl transition-transform duration-300 hover:-translate-y-2">
                ...
                <div class="relative mt-6 flex items-start gap-4">
                    <div class="flex h-14 w-14 items-center justify-center rounded-2xl bg-purple-500/20 text-white">
                        <svg class="h-7 w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9 2H7a2 2 0 00-2 2v16a2 2 0 002 2h10a2 2 0 002-2v-5m-6-9l6 6m-6-6v6h6"></path>
                        </svg>
                    </div>
                    <div>
                        <h3 class="text-2xl font-bold text-white text-high-contrast">Kelas Desain</h3>
                        <p class="mt-3 text-sm leading-relaxed text-white/75">
                            Kuasai desain grafis, tipografi, dan storytelling visual menggunakan tools industri seperti Figma dan Adobe Suite.
                        </p>
                    </div>
                </div>
                <dl class="mt-8 space-y-4 text-sm text-white/80">
                ...
                <div class="mt-9">
                    <a href="#pricing" class="inline-flex w-full items-center justify-center rounded-2xl border border-white/20 bg-white/10 px-6 py-3 text-sm font-bold text-white backdrop-blur-xl transition-all duration-300 hover:bg-white/20">
            ...
            <div class="group relative flex h-full flex-col overflow-hidden rounded-3xl border border-white/15 bg-white/5 p-8 shadow-2xl shadow-indigo-900/30 backdrop-blur-xl transition-transform duration-300 hover:-translate-y-2">
                ...
                <div class="relative mt-6 flex items-start gap-4">
                    <div class="flex h-14 w-14 items-center justify-center rounded-2xl bg-indigo-500/20 text-white">
                        <svg class="h-7 w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9 2v2m6-2v2M9 20v2m6-2v2M4 7h16M4 17h16M7 7v10m10-10v10M9 11h6v4H9z"></path>
                        </svg>
                    </div>
                    <div>
                        <h3 class="text-2xl font-bold text-white text-high-contrast">Kelas Robotik</h3>
                        <p class="mt-3 text-sm leading-relaxed text-white/75">
                            Merakit MRT 1, memahami sensor dasar, hingga memprogram pergerakan robot dengan teknik block coding dan Python.
                        </p>
                    </div>
                </div>
                <dl class="mt-8 space-y-4 text-sm text-white/80">
