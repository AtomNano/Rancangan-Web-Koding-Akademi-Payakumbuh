...
@section('title', 'Login - Materi Online')
    ...
    <div class="w-full max-w-md">
        <div class="bg-white shadow-2xl rounded-lg p-8">
            <div class="text-center mb-8">
                ...
                <p class="mt-2 text-sm text-gray-600">Silakan login menggunakan akun yang telah dibuat oleh admin</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}" 
                        ...
                        focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm text-gray-900" 
                        required autofocus />
                ...
                <div class="mt-4 pt-4 border-t border-gray-200">
                    <p class="text-sm text-gray-500 text-center mb-3">Quick Login (Development Only)</p>
