        ...
        <div class="pdf-reading-mode" id="pdfReadingMode">
                ...
                <div class="p-6">
                    ...
                    <div class="mb-6 pb-6 border-b border-gray-200">
                        ...
                        <div class="space-y-2">
                            ...
                            @elseif($materi->status === 'pending')
                                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mt-2">
                                    <p class="text-xs text-yellow-800">
                                        Materi ini sedang menunggu verifikasi dari admin sebelum dapat diakses oleh siswa.
                                    </p>
                                </div>
                            @endif
                        </div>
            ...
            <div class="fixed inset-0 transition-all duration-300" id="mainContent" style="margin: 0; padding: 0;">
                ...
                <div class="w-full h-full bg-gray-900" id="pdfViewerContainer">
                    <iframe id="pdfViewer" 
                            src="{{ route('guru.materi.download', $materi) }}#toolbar=0&navpanes=0&scrollbar=1&zoom=page-fit" 
                            class="w-full h-full"
                            frameborder="0">
                    </iframe>
                </div>
    ...
    @else
        ...
        <x-slot name="header">
            <div class="flex items-center">
                <a href="{{ route('guru.materi.index') }}" class="text-indigo-500 hover:text-indigo-700">
                            ...
                            <div class="mb-8">
                                ...
                                <div class="border border-gray-200 rounded-lg overflow-hidden">
                                    <video controls class="w-full">
                                        <source src="{{ route('guru.materi.download', $materi) }}" type="video/mp4">
