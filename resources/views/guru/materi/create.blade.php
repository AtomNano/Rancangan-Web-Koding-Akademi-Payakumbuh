                    ...
                    <form id="uploadForm" action="{{ route('guru.materi.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div id="file_input_wrapper" class="{{ old('file_type') === 'video' ? 'hidden' : '' }}">
                                ...
                                <input id="file" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" type="file" name="file" {{ old('file_type') === 'video' ? '' : 'required' }} />
