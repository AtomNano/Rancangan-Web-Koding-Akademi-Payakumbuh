                            ...
                            <div>
                                ...
                                <select id="materi_id" 
                                    ...
                                    @foreach($materis as $materi)
                                        <option value="{{ $materi->id }}" {{ old('materi_id', $pertemuan->materi_id) == $materi->id ? 'selected' : '' }}>
                                            {{ $materi->judul }}
                                        </option>
                                    @endforeach
                                </select>
                                <p class="mt-1 text-xs text-gray-500">Pilih materi yang dipelajari pada pertemuan ini</p>
                            </div>
